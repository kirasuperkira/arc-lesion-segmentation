"""
Contract tests: validate that API responses match the documented
schema (as published in /openapi.json), independent of the specific
...
def test_health_response_matches_schema(client):
    ...
    # sanity-check the schema actually documents this path
